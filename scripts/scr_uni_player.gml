...
with(obj_uni_startsing){instance_destroy(); event_user(3); instance_create(x,y,obj_uni_start);}
with(obj_uni_flagpole){instance_destroy(); instance_create(x,y,obj_flagpole);}
with(obj_uni_goalgate){instance_destroy(); instance_create(x,y,obj_smw_goalgate);}
with(obj_uni_shine){instance_destroy(); instance_create(x,y,obj_shine);}
//------------ Objetos gerais ------------
with(obj_uni_ground){instance_destroy(); event_user(3)}
with(obj_uni_demo_2){instance_destroy(); event_user(3)}
with(obj_uni_demo_3){instance_destroy(); event_user(3) instance_create(x,y,obj_slippery);}
with(obj_uni_demo_4_1){instance_destroy(); instance_create(x,y,obj_expandplatform_h);}
with(obj_uni_demo_4_2){instance_destroy(); instance_create(x,y,obj_expandplatform_v);}
with(obj_uni_demo_4_3){instance_destroy(); instance_create(x,y,obj_expandplatform_hv);}
with(obj_uni_demo_5_1){instance_destroy(); instance_create(x,y,obj_flowerblock);} 
with(obj_uni_demo_5_2){instance_destroy(); instance_create(x,y,obj_hammerblock);}
with(obj_uni_demo_5_3){instance_destroy(); instance_create(x,y,obj_boomerangblock);}
with(obj_uni_demo_5_4){instance_destroy(); instance_create(x,y,obj_starblock);}
with(obj_uni_demo_6){instance_destroy(); instance_create(x,y,obj_arrowplatform);}
with(obj_uni_demo_7){instance_destroy(); instance_create(x,y,obj_noteblock);}
with(obj_uni_demo_10){instance_destroy(); instance_create(x,y,obj_flipblock);}
with(obj_uni_demo_11){instance_destroy(); instance_create(x,y,obj_propellerblock);}
with(obj_uni_demo_12){instance_destroy(); instance_create(x,y,obj_bluebrick);}
with(obj_uni_demo_13){instance_destroy(); instance_create(x,y,obj_block_pow);}
with(obj_uni_demo_14){instance_destroy(); instance_create(x,y,obj_block_view);}
with(obj_uni_demo_15){instance_destroy(); instance_create(x,y,obj_onoffblock);}
with(obj_uni_demo_16){instance_destroy(); instance_create(x,y,obj_onoffplatform);}
with(obj_uni_demo_17_1){instance_destroy(); instance_create(x,y,obj_coin);}
with(obj_uni_demo_17_2){instance_destroy(); instance_create(x,y,obj_pcoin);}
with(obj_uni_demo_18_1){instance_destroy(); instance_create(x,y,obj_pswitch);}
with(obj_uni_demo_19){instance_destroy(); instance_create(x,y,obj_hatch);}
with(obj_uni_demo_20){instance_destroy(); instance_create(x,y,obj_getshoe);}
with(obj_uni_demo_21){instance_destroy(); instance_create(x,y,obj_poison);}
with(obj_uni_demo_22){instance_destroy(); instance_create(x,y,obj_1up);}
with(obj_uni_demo_23){instance_destroy(); instance_create(x,y,obj_3upmoon);}
with(obj_uni_demo_24){instance_destroy(); instance_create(x,y,obj_star);}
with(obj_uni_demo_25){instance_destroy(); instance_create(x,y,obj_mushroom);}
with(obj_uni_demo_26){instance_destroy(); instance_create(x,y,obj_fireflower);}
with(obj_uni_demo_27){instance_destroy(); instance_create(x,y,obj_hammersuit);}
with(obj_uni_demo_28){instance_destroy(); instance_create(x,y,obj_leaf);}
with(obj_uni_demo_29){instance_destroy(); instance_create(x,y,obj_superflower);}
with(obj_uni_demo_30){instance_destroy(); instance_create(x,y,obj_blueshell);}
with(obj_uni_demo_31){instance_destroy(); instance_create(x,y,obj_beeshroom);}
with(obj_uni_demo_32){instance_destroy(); instance_create(x,y,obj_iceflower);}
with(obj_uni_demo_33){instance_destroy(); instance_create(x,y,obj_boomerangflower);}
with(obj_uni_demo_34){instance_destroy(); instance_create(x,y,obj_propellershroom);}
...
with(obj_uni_demo_41){instance_destroy(); instance_create(x,y,obj_buzzybeetle);}
with(obj_uni_demo_42){instance_destroy(); instance_create(x+8,y,obj_spiketop);}
with(obj_uni_demo_43){instance_destroy(); instance_create(x-8,y,obj_cheepcheep);}
with(obj_uni_demo_44){instance_destroy(); instance_create(x,y,obj_blooper);}
with(obj_uni_demo_45){instance_destroy(); instance_create(x,y,obj_porchupuffer);}
with(obj_uni_demo_46){instance_destroy(); instance_create(x,y,obj_podoboo);}
with(obj_uni_demo_47){instance_destroy(); instance_create(x+17,y+16,obj_drybones);}
with(obj_uni_demo_48){instance_destroy(); instance_create(x,y,obj_thwomp);}
with(obj_uni_demo_48_1){instance_destroy(); instance_create(x,y,obj_thwimp);}
with(obj_uni_demo_48_2){instance_destroy(); instance_create(x,y,obj_thwimp_2);}
with(obj_uni_demo_49){instance_destroy(); instance_create(x,y,obj_boo);}
with(obj_uni_demo_50){instance_destroy(); instance_create(x,y,obj_bobomb);}
with(obj_uni_demo_51){instance_destroy(); instance_create(x,y,obj_rex);}
with(obj_uni_demo_52){instance_destroy(); instance_create(x+16,y,obj_chargingchuck);}
with(obj_uni_demo_53){instance_destroy(); instance_create(x,y,obj_roundgoomba);}
with(obj_uni_demo_54_1){instance_destroy(); with(instance_create(x,y,obj_diacannon)) image_index = 0;}
with(obj_uni_demo_54_2){instance_destroy(); with(instance_create(x,y,obj_diacannon)) image_index = 1;}
with(obj_uni_demo_54_3){instance_destroy(); with(instance_create(x,y,obj_diacannon)) image_index = 2;}
with(obj_uni_demo_54_4){instance_destroy(); with(instance_create(x,y,obj_diacannon)) image_index = 3;}
with(obj_uni_demo_55){instance_destroy(); instance_create(x,y,obj_monty);}
with(obj_uni_demo_56){instance_destroy(); instance_create(x,y,obj_vulcanolotus);}
with(obj_uni_demo_57){instance_destroy(); instance_create(x,y,obj_firesnake);}
with(obj_uni_demo_58){instance_destroy(); instance_create(x+8,y,obj_nipper);} //<errado
with(obj_uni_demo_59){instance_destroy(); instance_create(x,y,obj_torpedolaunch);}
with(obj_uni_demo_60){instance_destroy(); instance_create(x+16,y,obj_newbowser);}
with(obj_uni_demo_61){instance_destroy(); event_user(3)}
with(obj_uni_demo_62){instance_destroy(); event_user(3)}
with(obj_uni_demo_63_1){instance_destroy(); instance_create(x,y,obj_vengine); instance_create(x,y,obj_engineblock_v);}
with(obj_uni_demo_63_2){instance_destroy(); instance_create(x,y,obj_vengine2); instance_create(x,y-16,obj_engineblock_v);}
with(obj_uni_demo_63_3){instance_destroy(); instance_create(x,y,obj_engine2); instance_create(x-16,y,obj_engineblock_h);}
with(obj_uni_demo_63_4){instance_destroy(); instance_create(x,y,obj_engine); instance_create(x,y,obj_engineblock_h);}
with(obj_uni_demo_64_1){instance_destroy(); instance_create(x,y,obj_bulletblaster);}
with(obj_uni_demo_64_2){instance_destroy(); instance_create(x,y,obj_bulletblaster_2);}
with(obj_uni_demo_65_1){instance_destroy(); event_user(3)};
with(obj_uni_demo_65_2){instance_destroy(); event_user(3)};
with(obj_uni_demo_66){instance_destroy(); event_user(3)}
with(obj_uni_demo_67_1){instance_destroy(); instance_create(x,y,obj_donut);}
with(obj_uni_demo_67_2){instance_destroy(); instance_create(x,y,obj_donut_red);}
with(obj_uni_demo_68_1){instance_destroy(); with(instance_create(x,y,obj_platform_automoving)) type = 0;}
with(obj_uni_demo_68_2){instance_destroy(); with(instance_create(x,y,obj_platform_automoving)) type = 1;}
with(obj_uni_demo_68_3){instance_destroy(); with(instance_create(x,y,obj_platform_automoving)) type = 2;}
with(obj_uni_demo_68_4){instance_destroy(); with(instance_create(x,y,obj_platform_automoving)) type = 3;}
with(obj_uni_demo_69){instance_destroy(); event_user(3)}
with(obj_uni_demo_70_1){instance_destroy(); instance_create(x,y,obj_spring);}
with(obj_uni_demo_70_2){instance_destroy(); instance_create(x+16,y+12,obj_spring_super);}
with(obj_uni_demo_71){instance_destroy(); event_user(3)}
with(obj_uni_demo_72){instance_destroy(); instance_create(x,y,obj_key);}
with(obj_uni_demo_73){instance_destroy(); instance_create(x,y,obj_doorwall);}
with(obj_uni_demo_74_1){instance_destroy(); instance_create(x-8,y-1,obj_flippers_bottom);}
with(obj_uni_demo_74_2){instance_destroy(); instance_create(x-8,y,obj_flippers_top);}
with(obj_uni_demo_74_3){instance_destroy(); instance_create(x-14,y-8,obj_flippers_left);}
with(obj_uni_demo_74_4){instance_destroy(); instance_create(x-1,y-8,obj_flippers_right);}
with(obj_uni_demo_75){instance_destroy(); instance_create(x,y,obj_keyhole);}
with(obj_uni_demo_76){instance_destroy(); instance_create(x,y,obj_endboss);}
with(obj_uni_demo2_bgo1){instance_destroy(); event_user(3);}
with(obj_uni_demo2_bgo2){instance_destroy(); event_user(3);}
...
with(obj_uni_demo_104){instance_destroy(); instance_create(x,y,obj_sumobro);}
with(obj_uni_demo_105){instance_destroy(); instance_create(x,y,obj_platformspin);}
with(obj_uni_demo_106_1){instance_destroy(); instance_create(x,y,obj_walltriangle_r);}
with(obj_uni_demo_106_2){instance_destroy(); instance_create(x,y,obj_walltriangle_ir);}
with(obj_uni_demo_106_3){instance_destroy(); instance_create(x,y,obj_walltriangle_l);}
with(obj_uni_demo_106_4){instance_destroy(); instance_create(x,y,obj_walltriangle_il);}
...
//Portas Trancadas
with(obj_uni_demo_item_94_1_1){visible = 0; instance_create(x,y,obj_door_key_1_1);}
with(obj_uni_demo_item_94_1_2){visible = 0; instance_create(x,y,obj_door_key_1_2);}
with(obj_uni_demo_item_94_2_1){visible = 0; instance_create(x,y,obj_door_key_2_1);}
with(obj_uni_demo_item_94_2_2){visible = 0; instance_create(x,y,obj_door_key_2_2);}
with(obj_uni_demo_item_94_3_1){visible = 0; instance_create(x,y,obj_door_key_3_1);}
with(obj_uni_demo_item_94_3_2){visible = 0; instance_create(x,y,obj_door_key_3_2);}
with(obj_uni_demo_item_94_4_1){visible = 0; instance_create(x,y,obj_door_key_4_1);}
with(obj_uni_demo_item_94_4_2){visible = 0; instance_create(x,y,obj_door_key_4_2);}

//P-Door
with(obj_uni_demo_95_1_1){visible = 0; instance_create(x,y,obj_door_p_1_1);}
with(obj_uni_demo_95_1_2){visible = 0; instance_create(x,y,obj_door_p_1_2);}
with(obj_uni_demo_95_2_1){visible = 0; instance_create(x,y,obj_door_p_2_1);}
with(obj_uni_demo_95_2_2){visible = 0; instance_create(x,y,obj_door_p_2_2);}
with(obj_uni_demo_95_3_1){visible = 0; instance_create(x,y,obj_door_p_3_1);}
with(obj_uni_demo_95_3_2){visible = 0; instance_create(x,y,obj_door_p_3_2);}
with(obj_uni_demo_95_4_1){visible = 0; instance_create(x,y,obj_door_p_4_1);}
with(obj_uni_demo_95_4_2){visible = 0; instance_create(x,y,obj_door_p_4_2);}

//Warp Box
with(obj_uni_demo_96_1_1){visible = 0; instance_create(x,y,obj_warpbox_1_1);}
with(obj_uni_demo_96_1_2){visible = 0; instance_create(x,y,obj_warpbox_1_2);}
with(obj_uni_demo_96_2_1){visible = 0; instance_create(x,y,obj_warpbox_2_1);}
with(obj_uni_demo_96_2_2){visible = 0; instance_create(x,y,obj_warpbox_2_2);}
with(obj_uni_demo_96_3_1){visible = 0; instance_create(x,y,obj_warpbox_3_1);}
with(obj_uni_demo_96_3_2){visible = 0; instance_create(x,y,obj_warpbox_3_2);}
with(obj_uni_demo_96_4_1){visible = 0; instance_create(x,y,obj_warpbox_4_1);}
with(obj_uni_demo_96_4_2){visible = 0; instance_create(x,y,obj_warpbox_4_2);}
...
//UniMaker 1.S
with(obj_uni_demo_2_2){instance_destroy(); event_user(3)}
with(obj_uni_demo_2_3){instance_destroy(); event_user(3)}
with(obj_uni_demo2_ssp1){instance_destroy(); event_user(3)}
with(obj_uni_demo2_ssp2){instance_destroy(); event_user(3)}
with(obj_uni_demo2_ssp3){instance_destroy(); event_user(3)}
with(obj_uni_demo2_mp1){instance_destroy(); event_user(3)}
with(obj_uni_demo2_mp2){instance_destroy(); event_user(3)}
with(obj_uni_demo2_mp3){instance_destroy(); event_user(3)}
with(obj_uni_demo_71_2){instance_destroy(); event_user(3)}
with(obj_uni_demo_71_3){instance_destroy(); event_user(3)}
with(obj_uni_demo_16_2){instance_destroy(); instance_create(x,y,obj_onoffplatform_off)};
with(obj_uni_demo_62_2){instance_destroy(); instance_create(x,y,obj_modelhurt_solid)}
with(obj_uni_demo_2_2){instance_destroy(); event_user(3)}
with(obj_uni_demo_2_3){instance_destroy(); event_user(3)}
with(obj_checkpoint_edit){instance_destroy(); instance_create(x,y,obj_checkpoint)}
with(obj_goalpole_block){instance_destroy(); event_user(3)}
with(obj_goalpole_castle){instance_destroy(); event_user(3)}
